...
INSTALL_ROOT="${RAGFLOW_EVAL_INSTALL_ROOT:-/Users/letouch/Library/Application Support/letouch-ragflow}"
RUN_ROOT="${RAGFLOW_EVAL_RUN_ROOT:-/Users/letouch/Library/Logs/letouch-ragflow/evaluation}"
